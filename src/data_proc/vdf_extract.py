...
def extract_vdf(file_location, cid, box=-1, pop="avgs"):
    ...
    Opens the `.vlsv` file, reads the sparse velocity-space data stored for
    the given cell, places the values into a full velocity-space grid, sorts
    the grid by velocity coordinates, and returns the VDF as a dense NumPy
    array.
